...
function Dashboard({firstname}){
    ...
    return (
      <div className=" col-span-1 flex justify-between items-center">
        <div className='max-my4:items-center  w-screen my4:rounded-non bg-[#08235A]  my4:w-64  my4:h-screen '>
          <div className='flex  my4:flex-col '>
            ...
            <div className="max-my4:hidden flex my4:flex-col justify-center items-center">
              <div className='text-center text-white  my4:w-48 my4:h-12 ml-3 mr-4 mt-2 text-sm font-normal hover:cursor-pointer'><div className='mt-2.5 mr-4 '>Dashboard</div></div>
